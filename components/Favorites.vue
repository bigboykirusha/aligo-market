<template>
   <div class="favorites">
      ...
      <FavoritesList v-if="loading" :ads="[]" />
      <FavoritesList v-show="!loading && favorites.length" :ads="favorites" />
      <div v-show="!loading && !favorites.length" class="favorites__placeholder">
         ...
         <p class="favorites__placeholder-description">
            Используйте <img src="../assets/icons/fav.svg" />, чтобы сохранить объявление в избранное
         </p>
      </div>
   </div>
</template>
